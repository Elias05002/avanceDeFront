  ...
  return (
    ...
    >
      ...
      <View style={styles.container}>
        ...
        />
          <Text style={styles.title}>Bienvenido Empleado</Text>
          <TouchableOpacity style={styles.button}>
          <Text onPress={()=> alert("pressed")} style={styles.buttonText}>Cambios Clientes</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Bajas Clientes</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Logs Clientes</Text>
        </TouchableOpacity>

    ...
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button}>
          <Text onPress={()=> alert("ChtmLuis")} style={styles.buttonText}>Logs Clientes</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Logs Empleado</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Cambios Clientes</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Bajas Clientes</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Cambios Empleados</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => navigate('')}>
          <Text style={styles.buttonText}>Bajas Empleados</Text>
        </TouchableOpacity>
